...
fontList = ["big", "bulbhead", "roman", "epic", "larry3d", "speed", "nancyj", "stampatello", "smslant", "slscript",
            "serifcap", "rounded", "puffy", "o8", "letters", "colossal", "basic"]
...
parser = argparse.ArgumentParser(prog="hackwall\n", description="Threat Analysis Tool for End User",
